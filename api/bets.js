...
export default async function handler(req, res) {
  if (handleOPTIONS(req, res)) return; // trata o OPTIONS e encerra
  applyCORS(req, res);                  // aplica CORS na requisição real
  ...
  try {
    ...
    // TODO: ligar no Supabase quando houver tabela de apostas
    const items = [];
